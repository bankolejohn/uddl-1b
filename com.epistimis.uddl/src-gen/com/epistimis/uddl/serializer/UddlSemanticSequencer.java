...
public class UddlSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == UddlPackage.eINSTANCE)
			...
			case UddlPackage.DATA_MODEL:
				...
				return; 
			case UddlPackage.ELEMENT_ATTRS:
				sequence_ElementAttrs(context, (ElementAttrs) semanticObject); 
				return; 
	 ...
	 *         rolename=ID 
	 *         lowerBound=INT? 
	 *         (upperBound=INT | upperBound=SIGNED_INT)? 
	 *         description=STRING? 
	 ...
	 *
	 * Constraint:
	 *     (name=ID description=STRING? basisEntity+=[ConceptualBasisEntity|QN]*)
	 * </pre>
	 */
	 ...
	 *         (sourceUpperBound=INT | sourceUpperBound=SIGNED_INT) 
	 ...
	 * <pre>
	 * Contexts:
	 *     ElementAttrs returns ElementAttrs
	 *
	 * Constraint:
	 *     (name=ID description=STRING?)
	 * </pre>
	 */
	protected void sequence_ElementAttrs(ISerializationContext context, ElementAttrs semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *         rolename=ID 
	 *         (lowerBound=INT (upperBound=INT | upperBound=SIGNED_INT))? 
	 *         description=STRING? 
	 ...
	 *
	 * Constraint:
	 *     (name=ID description=STRING? source=[LogicalUnit|QN] destination=[LogicalUnit|QN])
	 * </pre>
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID description=STRING? allowedValue+=[LogicalEnumeratedBase|QN]*)
	 * </pre>
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID (lowerBound=INT | lowerBound=SIGNED_INT) (upperBound=INT | upperBound=SIGNED_INT) description=STRING?)
	 * </pre>
	 */
	 ...
	 *     LogicalAbstractMeasurement returns LogicalMeasurementAxis
	 ...
	 *     LogicalAbstractMeasurement returns LogicalMeasurement
	 ...
	 *     LogicalAbstractMeasurement returns LogicalValueTypeUnit
	 *
	 * Constraint:
	 ...
	 *
	 * Constraint:
	 *     (includes+=Include* dataModel=DataModel)
	 * </pre>
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID description=STRING? realizes=[LogicalCompositeQuery|QN]? isUnion?='isUnion' composition+=PlatformQueryComposition)
	 * </pre>
	 */
