...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Logical Measurement System Conversion</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.epistimis.uddl.uddl.impl.LogicalMeasurementSystemConversionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link com.epistimis.uddl.uddl.impl.LogicalMeasurementSystemConversionImpl#getEquation <em>Equation</em>}</li>
 *   <li>{@link com.epistimis.uddl.uddl.impl.LogicalMeasurementSystemConversionImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link com.epistimis.uddl.uddl.impl.LogicalMeasurementSystemConversionImpl#getConversionLossDescription <em>Conversion Loss Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicalMeasurementSystemConversionImpl extends LogicalElementImpl implements LogicalMeasurementSystemConversion
{
  /**
   ...
   * @generated
   */
  protected LogicalMeasurementSystemConversionImpl()
  {
    super();
  }
  ...
  {
    return UddlPackage.Literals.LOGICAL_MEASUREMENT_SYSTEM_CONVERSION;
  }
    ...
    if (source != null && source.eIsProxy())
    {
      ...
      if (source != oldSource)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UddlPackage.LOGICAL_MEASUREMENT_SYSTEM_CONVERSION__SOURCE, oldSource, source));
      }
    }
    return source;
  }
  ...
  public void setSource(LogicalMeasurementSystem newSource)
  {
    ...
    source = newSource;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UddlPackage.LOGICAL_MEASUREMENT_SYSTEM_CONVERSION__SOURCE, oldSource, source));
  }
  ...
  public EList<String> getEquation()
  {
    if (equation == null)
    {
      equation = new EDataTypeEList<String>(String.class, this, UddlPackage.LOGICAL_MEASUREMENT_SYSTEM_CONVERSION__EQUATION);
    }
    return equation;
  }
  ...
  public LogicalMeasurementSystem getDestination()
  {
    if (destination != null && destination.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UddlPackage.LOGICAL_MEASUREMENT_SYSTEM_CONVERSION__DESTINATION, oldDestination, destination));
      }
    }
    return destination;
  }
  ...
  public void setDestination(LogicalMeasurementSystem newDestination)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UddlPackage.LOGICAL_MEASUREMENT_SYSTEM_CONVERSION__DESTINATION, oldDestination, destination));
  }
  ...
  public void setConversionLossDescription(String newConversionLossDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UddlPackage.LOGICAL_MEASUREMENT_SYSTEM_CONVERSION__CONVERSION_LOSS_DESCRIPTION, oldConversionLossDescription, conversionLossDescription));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UddlPackage.LOGICAL_MEASUREMENT_SYSTEM_CONVERSION__SOURCE:
        if (resolve) return getSource();
        return basicGetSource();
      case UddlPackage.LOGICAL_MEASUREMENT_SYSTEM_CONVERSION__EQUATION:
        return getEquation();
      case UddlPackage.LOGICAL_MEASUREMENT_SYSTEM_CONVERSION__DESTINATION:
        if (resolve) return getDestination();
        return basicGetDestination();
      case UddlPackage.LOGICAL_MEASUREMENT_SYSTEM_CONVERSION__CONVERSION_LOSS_DESCRIPTION:
...
} //LogicalMeasurementSystemConversionImpl
