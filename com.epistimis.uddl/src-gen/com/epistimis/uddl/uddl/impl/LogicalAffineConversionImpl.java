 ...
 *   <li>{@link com.epistimis.uddl.uddl.impl.LogicalAffineConversionImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicalAffineConversionImpl extends LogicalConversionImpl implements LogicalAffineConversion
{
   ...
   */
  @Override
  public LogicalUnit getTarget()
  {
    if (target != null && target.eIsProxy())
    {
      InternalEObject oldTarget = (InternalEObject)target;
      target = (LogicalUnit)eResolveProxy(oldTarget);
      if (target != oldTarget)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UddlPackage.LOGICAL_AFFINE_CONVERSION__TARGET, oldTarget, target));
      }
    }
    return target;
  }
   ...
   * @generated
   */
  public LogicalUnit basicGetTarget()
  {
    return target;
  }
   ...
   */
  @Override
  public void setTarget(LogicalUnit newTarget)
  {
    LogicalUnit oldTarget = target;
    target = newTarget;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UddlPackage.LOGICAL_AFFINE_CONVERSION__TARGET, oldTarget, target));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case UddlPackage.LOGICAL_AFFINE_CONVERSION__OFFSET:
        return getOffset();
      case UddlPackage.LOGICAL_AFFINE_CONVERSION__TARGET:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case UddlPackage.LOGICAL_AFFINE_CONVERSION__OFFSET:
        ...
        return;
      case UddlPackage.LOGICAL_AFFINE_CONVERSION__TARGET:
        setTarget((LogicalUnit)newValue);
        return;
    }
