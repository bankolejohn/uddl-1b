 ...
 * </p>
 * <ul>
 *   <li>{@link com.epistimis.uddl.uddl.impl.PlatformCompositeQueryImpl#getRealizes <em>Realizes</em>}</li>
...
public class PlatformCompositeQueryImpl extends PlatformViewImpl implements PlatformCompositeQuery
{
    ...
    if (realizes != null && realizes.eIsProxy())
    {
      ...
      if (realizes != oldRealizes)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UddlPackage.PLATFORM_COMPOSITE_QUERY__REALIZES, oldRealizes, realizes));
      }
    }
    return realizes;
  }
  ...
  public void setRealizes(LogicalCompositeQuery newRealizes)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UddlPackage.PLATFORM_COMPOSITE_QUERY__REALIZES, oldRealizes, realizes));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UddlPackage.PLATFORM_COMPOSITE_QUERY__REALIZES:
