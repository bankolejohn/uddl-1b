...
public class UddlGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ModelFileElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.epistimis.uddl.Uddl.ModelFile");
		...
		private final RuleCall cDataModelDataModelParserRuleCall_1_0 = (RuleCall)cDataModelAssignment_1.eContents().get(0);
		...
		//DataModel
		public RuleCall getDataModelDataModelParserRuleCall_1_0() { return cDataModelDataModelParserRuleCall_1_0; }
	}
	...
	public class ElementAttrsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.epistimis.uddl.Uddl.ElementAttrs");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConceptualDomainElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cBasisEntityAssignment_3_1 = (Assignment)cGroup_3.eContents().get(1);
		private final CrossReference cBasisEntityConceptualBasisEntityCrossReference_3_1_0 = (CrossReference)cBasisEntityAssignment_3_1.eContents().get(0);
		private final RuleCall cBasisEntityConceptualBasisEntityQNParserRuleCall_3_1_0_1 = (RuleCall)cBasisEntityConceptualBasisEntityCrossReference_3_1_0.eContents().get(1);
		...
		//basisEntity+=[ConceptualBasisEntity|QN]+
		public Assignment getBasisEntityAssignment_3_1() { return cBasisEntityAssignment_3_1; }
		
		//[ConceptualBasisEntity|QN]
		public CrossReference getBasisEntityConceptualBasisEntityCrossReference_3_1_0() { return cBasisEntityConceptualBasisEntityCrossReference_3_1_0; }
		
		//QN
		public RuleCall getBasisEntityConceptualBasisEntityQNParserRuleCall_3_1_0_1() { return cBasisEntityConceptualBasisEntityQNParserRuleCall_3_1_0_1; }
	...
	public class ConceptualCompositionElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cUpperBoundAlternatives_2_3_0 = (Alternatives)cUpperBoundAssignment_2_3.eContents().get(0);
		private final RuleCall cUpperBoundINTTerminalRuleCall_2_3_0_0 = (RuleCall)cUpperBoundAlternatives_2_3_0.eContents().get(0);
		private final RuleCall cUpperBoundSIGNED_INTTerminalRuleCall_2_3_0_1 = (RuleCall)cUpperBoundAlternatives_2_3_0.eContents().get(1);
		...
		//ConceptualComposition:
		//    type=[ConceptualComposableElement|QN]  rolename=ID ('[' (lowerBound=INT)? ':' (upperBound=(INT|SIGNED_INT))? ']')? (description=STRING)? (':' specializes=[ConceptualCharacteristic|QN])? ';'
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//('[' (lowerBound=INT)? ':' (upperBound=(INT|SIGNED_INT))? ']')?
		...
		//(upperBound=(INT|SIGNED_INT))?
		public Assignment getUpperBoundAssignment_2_3() { return cUpperBoundAssignment_2_3; }
		
		//(INT|SIGNED_INT)
		public Alternatives getUpperBoundAlternatives_2_3_0() { return cUpperBoundAlternatives_2_3_0; }
		
		//INT
		public RuleCall getUpperBoundINTTerminalRuleCall_2_3_0_0() { return cUpperBoundINTTerminalRuleCall_2_3_0_0; }
		
		//SIGNED_INT
		public RuleCall getUpperBoundSIGNED_INTTerminalRuleCall_2_3_0_1() { return cUpperBoundSIGNED_INTTerminalRuleCall_2_3_0_1; }
	...
	public class ConceptualAssociationElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cBasisEntityAssignment_6_2 = (Assignment)cGroup_6.eContents().get(2);
		private final CrossReference cBasisEntityConceptualBasisEntityCrossReference_6_2_0 = (CrossReference)cBasisEntityAssignment_6_2.eContents().get(0);
		private final RuleCall cBasisEntityConceptualBasisEntityQNParserRuleCall_6_2_0_1 = (RuleCall)cBasisEntityConceptualBasisEntityCrossReference_6_2_0.eContents().get(1);
		...
		//basisEntity+=[ConceptualBasisEntity|QN]+
		public Assignment getBasisEntityAssignment_6_2() { return cBasisEntityAssignment_6_2; }
		
		//[ConceptualBasisEntity|QN]
		public CrossReference getBasisEntityConceptualBasisEntityCrossReference_6_2_0() { return cBasisEntityConceptualBasisEntityCrossReference_6_2_0; }
		
		//QN
		public RuleCall getBasisEntityConceptualBasisEntityQNParserRuleCall_6_2_0_1() { return cBasisEntityConceptualBasisEntityQNParserRuleCall_6_2_0_1; }
	...
	public class ConceptualParticipantElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cSourceUpperBoundAlternatives_10_0 = (Alternatives)cSourceUpperBoundAssignment_10.eContents().get(0);
		private final RuleCall cSourceUpperBoundINTTerminalRuleCall_10_0_0 = (RuleCall)cSourceUpperBoundAlternatives_10_0.eContents().get(0);
		private final RuleCall cSourceUpperBoundSIGNED_INTTerminalRuleCall_10_0_1 = (RuleCall)cSourceUpperBoundAlternatives_10_0.eContents().get(1);
		...
		//ConceptualParticipant:
		//    type=[ConceptualEntity|QN]  rolename=ID ('[' (lowerBound=INT)? ':' (upperBound=(INT|SIGNED_INT))? ']')? (description=STRING)? (':' specializes=[ConceptualCharacteristic|QN])?
		//        '{'
		//            'src:' '['sourceLowerBound=INT ':' sourceUpperBound=(INT|SIGNED_INT) ']'
		...
		//sourceUpperBound=(INT|SIGNED_INT)
		public Assignment getSourceUpperBoundAssignment_10() { return cSourceUpperBoundAssignment_10; }
		
		//(INT|SIGNED_INT)
		public Alternatives getSourceUpperBoundAlternatives_10_0() { return cSourceUpperBoundAlternatives_10_0; }
		
		//INT
		public RuleCall getSourceUpperBoundINTTerminalRuleCall_10_0_0() { return cSourceUpperBoundINTTerminalRuleCall_10_0_0; }
		
		//SIGNED_INT
		public RuleCall getSourceUpperBoundSIGNED_INTTerminalRuleCall_10_0_1() { return cSourceUpperBoundSIGNED_INTTerminalRuleCall_10_0_1; }
	...
	public class LogicalConversionElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cSourceLogicalUnitCrossReference_0_4_0 = (CrossReference)cSourceAssignment_0_4.eContents().get(0);
		private final RuleCall cSourceLogicalUnitQNParserRuleCall_0_4_0_1 = (RuleCall)cSourceLogicalUnitCrossReference_0_4_0.eContents().get(1);
		...
		private final CrossReference cDestinationLogicalUnitCrossReference_0_6_0 = (CrossReference)cDestinationAssignment_0_6.eContents().get(0);
		private final RuleCall cDestinationLogicalUnitQNParserRuleCall_0_6_0_1 = (RuleCall)cDestinationLogicalUnitCrossReference_0_6_0.eContents().get(1);
		...
		//        source=[LogicalUnit|QN] '-()>'  destination=[LogicalUnit|QN]
		//        '};' |
		...
		//source=[LogicalUnit|QN]
		public Assignment getSourceAssignment_0_4() { return cSourceAssignment_0_4; }
		
		//[LogicalUnit|QN]
		public CrossReference getSourceLogicalUnitCrossReference_0_4_0() { return cSourceLogicalUnitCrossReference_0_4_0; }
		
		//QN
		public RuleCall getSourceLogicalUnitQNParserRuleCall_0_4_0_1() { return cSourceLogicalUnitQNParserRuleCall_0_4_0_1; }
		...
		//destination=[LogicalUnit|QN]
		public Assignment getDestinationAssignment_0_6() { return cDestinationAssignment_0_6; }
		
		//[LogicalUnit|QN]
		public CrossReference getDestinationLogicalUnitCrossReference_0_6_0() { return cDestinationLogicalUnitCrossReference_0_6_0; }
		
		//QN
		public RuleCall getDestinationLogicalUnitQNParserRuleCall_0_6_0_1() { return cDestinationLogicalUnitQNParserRuleCall_0_6_0_1; }
	...
	public class LogicalAffineConversionElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cSourceLogicalUnitCrossReference_4_0 = (CrossReference)cSourceAssignment_4.eContents().get(0);
		private final RuleCall cSourceLogicalUnitQNParserRuleCall_4_0_1 = (RuleCall)cSourceLogicalUnitCrossReference_4_0.eContents().get(1);
		...
		private final CrossReference cTargetLogicalUnitCrossReference_11_0 = (CrossReference)cTargetAssignment_11.eContents().get(0);
		private final RuleCall cTargetLogicalUnitQNParserRuleCall_11_0_1 = (RuleCall)cTargetLogicalUnitCrossReference_11_0.eContents().get(1);
		...
		//        source=[LogicalUnit|QN] '-(' 'm:' conversionFactor=FLOAT 'b:' offset=FLOAT ')->'  target=[LogicalUnit|QN]
		//    '};'
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//[LogicalUnit|QN]
		public CrossReference getSourceLogicalUnitCrossReference_4_0() { return cSourceLogicalUnitCrossReference_4_0; }
		
		//QN
		public RuleCall getSourceLogicalUnitQNParserRuleCall_4_0_1() { return cSourceLogicalUnitQNParserRuleCall_4_0_1; }
		...
		//target=[LogicalUnit|QN]
		public Assignment getTargetAssignment_11() { return cTargetAssignment_11; }
		
		//[LogicalUnit|QN]
		public CrossReference getTargetLogicalUnitCrossReference_11_0() { return cTargetLogicalUnitCrossReference_11_0; }
		
		//QN
		public RuleCall getTargetLogicalUnitQNParserRuleCall_11_0_1() { return cTargetLogicalUnitQNParserRuleCall_11_0_1; }
	...
	public class LogicalEnumeratedElements extends AbstractParserRuleElementFinder {
		...
		//LogicalEnumerated:
		//    'enum'     name=ID (description=STRING)? ('stdRef:' standardReference=STRING)?
		//        '['
	...
	public class LogicalMeasurementSystemElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cDescriptionSTRINGTerminalRuleCall_2_0 = (RuleCall)cDescriptionAssignment_2.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Keyword cMsaKeyword_4 = (Keyword)cGroup.eContents().get(4);
		...
		//        'msa:' '[' measurementSystemAxis+=[LogicalMeasurementSystemAxis|QN]+ ']'
		...
		//'msa:'
		public Keyword getMsaKeyword_4() { return cMsaKeyword_4; }
	...
	public class LogicalValueTypeUnitElements extends AbstractParserRuleElementFinder {
		...
		//    // NOTE: This has a single, optional attribute - so the curlies are optional as well
	...
	public class LogicalIntegerRangeConstraintElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cLowerBoundAlternatives_3_0 = (Alternatives)cLowerBoundAssignment_3.eContents().get(0);
		private final RuleCall cLowerBoundINTTerminalRuleCall_3_0_0 = (RuleCall)cLowerBoundAlternatives_3_0.eContents().get(0);
		private final RuleCall cLowerBoundSIGNED_INTTerminalRuleCall_3_0_1 = (RuleCall)cLowerBoundAlternatives_3_0.eContents().get(1);
		private final Keyword cColonKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Assignment cUpperBoundAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final Alternatives cUpperBoundAlternatives_5_0 = (Alternatives)cUpperBoundAssignment_5.eContents().get(0);
		private final RuleCall cUpperBoundINTTerminalRuleCall_5_0_0 = (RuleCall)cUpperBoundAlternatives_5_0.eContents().get(0);
		private final RuleCall cUpperBoundSIGNED_INTTerminalRuleCall_5_0_1 = (RuleCall)cUpperBoundAlternatives_5_0.eContents().get(1);
		...
		//LogicalIntegerRangeConstraint:
		//    'irc'  name=ID '[' lowerBound=(INT|SIGNED_INT) ':' upperBound=(INT|SIGNED_INT) ']' (description=STRING)?  ';'
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//lowerBound=(INT|SIGNED_INT)
		public Assignment getLowerBoundAssignment_3() { return cLowerBoundAssignment_3; }
		
		//(INT|SIGNED_INT)
		public Alternatives getLowerBoundAlternatives_3_0() { return cLowerBoundAlternatives_3_0; }
		
		//INT
		public RuleCall getLowerBoundINTTerminalRuleCall_3_0_0() { return cLowerBoundINTTerminalRuleCall_3_0_0; }
		
		//SIGNED_INT
		public RuleCall getLowerBoundSIGNED_INTTerminalRuleCall_3_0_1() { return cLowerBoundSIGNED_INTTerminalRuleCall_3_0_1; }
		...
		//(INT|SIGNED_INT)
		public Alternatives getUpperBoundAlternatives_5_0() { return cUpperBoundAlternatives_5_0; }
		
		//INT
		public RuleCall getUpperBoundINTTerminalRuleCall_5_0_0() { return cUpperBoundINTTerminalRuleCall_5_0_0; }
		
		//SIGNED_INT
		public RuleCall getUpperBoundSIGNED_INTTerminalRuleCall_5_0_1() { return cUpperBoundSIGNED_INTTerminalRuleCall_5_0_1; }
	...
	public class LogicalEnumerationConstraintElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cAllowedValueLogicalEnumeratedBaseCrossReference_4_1_0 = (CrossReference)cAllowedValueAssignment_4_1.eContents().get(0);
		private final RuleCall cAllowedValueLogicalEnumeratedBaseQNParserRuleCall_4_1_0_1 = (RuleCall)cAllowedValueLogicalEnumeratedBaseCrossReference_4_1_0.eContents().get(1);
		...
		//LogicalEnumerationConstraint :
		//    {LogicalEnumerationConstraint} 'ec' name=ID (description=STRING)? ('[' (allowedValue+=[LogicalEnumeratedBase|QN])+ ']')?
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//('[' (allowedValue+=[LogicalEnumeratedBase|QN])+ ']')?
		public Group getGroup_4() { return cGroup_4; }
		...
		//[LogicalEnumeratedBase|QN]
		public CrossReference getAllowedValueLogicalEnumeratedBaseCrossReference_4_1_0() { return cAllowedValueLogicalEnumeratedBaseCrossReference_4_1_0; }
		
		//QN
		public RuleCall getAllowedValueLogicalEnumeratedBaseQNParserRuleCall_4_1_0_1() { return cAllowedValueLogicalEnumeratedBaseQNParserRuleCall_4_1_0_1; }
	...
	public class LogicalAbstractMeasurementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.epistimis.uddl.Uddl.LogicalAbstractMeasurement");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cLogicalMeasurementParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cLogicalMeasurementAxisParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		private final RuleCall cLogicalValueTypeUnitParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		...
		//LogicalMeasurement
		public RuleCall getLogicalMeasurementParserRuleCall_0() { return cLogicalMeasurementParserRuleCall_0; }
		
		//// Use LogicalComposableElement
		//  LogicalMeasurementAxis
		public RuleCall getLogicalMeasurementAxisParserRuleCall_1() { return cLogicalMeasurementAxisParserRuleCall_1; }
		
		//// Use LogicalElement
		//   LogicalValueTypeUnit
		public RuleCall getLogicalValueTypeUnitParserRuleCall_2() { return cLogicalValueTypeUnitParserRuleCall_2; }
	}
	...
	public class LogicalMeasurementAxisElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cLeftCurlyBracketKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Keyword cMsaxisKeyword_5 = (Keyword)cGroup.eContents().get(5);
		private final Assignment cMeasurementSystemAxisAssignment_6 = (Assignment)cGroup.eContents().get(6);
		private final CrossReference cMeasurementSystemAxisLogicalMeasurementSystemAxisCrossReference_6_0 = (CrossReference)cMeasurementSystemAxisAssignment_6.eContents().get(0);
		private final RuleCall cMeasurementSystemAxisLogicalMeasurementSystemAxisQNParserRuleCall_6_0_1 = (RuleCall)cMeasurementSystemAxisLogicalMeasurementSystemAxisCrossReference_6_0.eContents().get(1);
		private final Group cGroup_7 = (Group)cGroup.eContents().get(7);
		private final Keyword cVtuKeyword_7_0 = (Keyword)cGroup_7.eContents().get(0);
		private final Keyword cLeftSquareBracketKeyword_7_1 = (Keyword)cGroup_7.eContents().get(1);
		private final Assignment cValueTypeUnitAssignment_7_2 = (Assignment)cGroup_7.eContents().get(2);
		private final CrossReference cValueTypeUnitLogicalValueTypeUnitCrossReference_7_2_0 = (CrossReference)cValueTypeUnitAssignment_7_2.eContents().get(0);
		private final RuleCall cValueTypeUnitLogicalValueTypeUnitQNParserRuleCall_7_2_0_1 = (RuleCall)cValueTypeUnitLogicalValueTypeUnitCrossReference_7_2_0.eContents().get(1);
		private final Keyword cRightSquareBracketKeyword_7_3 = (Keyword)cGroup_7.eContents().get(3);
		...
		//'msaxis:'
		public Keyword getMsaxisKeyword_5() { return cMsaxisKeyword_5; }
		...
		//'vtu:'
		public Keyword getVtuKeyword_7_0() { return cVtuKeyword_7_0; }
		
		//'['
		public Keyword getLeftSquareBracketKeyword_7_1() { return cLeftSquareBracketKeyword_7_1; }
		
		//valueTypeUnit+=[LogicalValueTypeUnit|QN]+
		public Assignment getValueTypeUnitAssignment_7_2() { return cValueTypeUnitAssignment_7_2; }
		
		//[LogicalValueTypeUnit|QN]
		public CrossReference getValueTypeUnitLogicalValueTypeUnitCrossReference_7_2_0() { return cValueTypeUnitLogicalValueTypeUnitCrossReference_7_2_0; }
		
		//QN
		public RuleCall getValueTypeUnitLogicalValueTypeUnitQNParserRuleCall_7_2_0_1() { return cValueTypeUnitLogicalValueTypeUnitQNParserRuleCall_7_2_0_1; }
	...
	public class LogicalMeasurementConversionElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cLeftCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cSourceAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final CrossReference cSourceLogicalMeasurementCrossReference_4_0 = (CrossReference)cSourceAssignment_4.eContents().get(0);
		private final RuleCall cSourceLogicalMeasurementQNParserRuleCall_4_0_1 = (RuleCall)cSourceLogicalMeasurementCrossReference_4_0.eContents().get(1);
		private final Keyword cHyphenMinusLeftParenthesisKeyword_5 = (Keyword)cGroup.eContents().get(5);
		private final Assignment cEquationAssignment_6 = (Assignment)cGroup.eContents().get(6);
		private final RuleCall cEquationSTRINGTerminalRuleCall_6_0 = (RuleCall)cEquationAssignment_6.eContents().get(0);
		private final Group cGroup_7 = (Group)cGroup.eContents().get(7);
		...
		private final CrossReference cTargetLogicalMeasurementCrossReference_9_0 = (CrossReference)cTargetAssignment_9.eContents().get(0);
		private final RuleCall cTargetLogicalMeasurementQNParserRuleCall_9_0_1 = (RuleCall)cTargetLogicalMeasurementCrossReference_9_0.eContents().get(1);
		private final Keyword cLossKeyword_10 = (Keyword)cGroup.eContents().get(10);
		private final Assignment cConversionLossDescriptionAssignment_11 = (Assignment)cGroup.eContents().get(11);
		private final RuleCall cConversionLossDescriptionSTRINGTerminalRuleCall_11_0 = (RuleCall)cConversionLossDescriptionAssignment_11.eContents().get(0);
		private final Keyword cRightCurlyBracketSemicolonKeyword_12 = (Keyword)cGroup.eContents().get(12);
		...
		//        source=[LogicalMeasurement|QN] '-(' equation+=STRING (',' equation+=STRING)? ')>' target=[LogicalMeasurement|QN]
		//        'loss:' conversionLossDescription=STRING
		//    '};'
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//source=[LogicalMeasurement|QN]
		public Assignment getSourceAssignment_4() { return cSourceAssignment_4; }
		
		//[LogicalMeasurement|QN]
		public CrossReference getSourceLogicalMeasurementCrossReference_4_0() { return cSourceLogicalMeasurementCrossReference_4_0; }
		
		//QN
		public RuleCall getSourceLogicalMeasurementQNParserRuleCall_4_0_1() { return cSourceLogicalMeasurementQNParserRuleCall_4_0_1; }
		...
		//target=[LogicalMeasurement|QN]
		public Assignment getTargetAssignment_9() { return cTargetAssignment_9; }
		
		//[LogicalMeasurement|QN]
		public CrossReference getTargetLogicalMeasurementCrossReference_9_0() { return cTargetLogicalMeasurementCrossReference_9_0; }
		
		//QN
		public RuleCall getTargetLogicalMeasurementQNParserRuleCall_9_0_1() { return cTargetLogicalMeasurementQNParserRuleCall_9_0_1; }
	...
	public class LogicalCompositionElements extends AbstractParserRuleElementFinder {
		...
		//LogicalComposition:
		//    type=[LogicalComposableElement|QN]  rolename=ID ('[' lowerBound=INT ':' upperBound=(INT|SIGNED_INT) ']')? (description=STRING)? (':' specializes=[LogicalCharacteristic|QN])?  '->' realizes=[ConceptualComposition|QN] ';'
		//;
		@Override public ParserRule getRule() { return rule; }
	...
	public class LogicalParticipantElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cSourceUpperBoundAlternatives_12_0 = (Alternatives)cSourceUpperBoundAssignment_12.eContents().get(0);
		private final RuleCall cSourceUpperBoundINTTerminalRuleCall_12_0_0 = (RuleCall)cSourceUpperBoundAlternatives_12_0.eContents().get(0);
		private final RuleCall cSourceUpperBoundSIGNED_INTTerminalRuleCall_12_0_1 = (RuleCall)cSourceUpperBoundAlternatives_12_0.eContents().get(1);
		...
		//LogicalParticipant:
		//    type=[LogicalEntity|QN]  rolename=ID ('[' lowerBound=INT ':' upperBound=(INT|SIGNED_INT) ']')? (description=STRING)? (':' specializes=[LogicalCharacteristic|QN])?  '->' realizes=[ConceptualParticipant|QN] '{'
		//        'source:' '[' sourceLowerBound=INT ':' sourceUpperBound=(INT|SIGNED_INT) ']'
		...
		//(INT|SIGNED_INT)
		public Alternatives getSourceUpperBoundAlternatives_12_0() { return cSourceUpperBoundAlternatives_12_0; }
		
		//INT
		public RuleCall getSourceUpperBoundINTTerminalRuleCall_12_0_0() { return cSourceUpperBoundINTTerminalRuleCall_12_0_0; }
		
		//SIGNED_INT
		public RuleCall getSourceUpperBoundSIGNED_INTTerminalRuleCall_12_0_1() { return cSourceUpperBoundSIGNED_INTTerminalRuleCall_12_0_1; }
	...
	public class PlatformCompositionElements extends AbstractParserRuleElementFinder {
		...
		//PlatformComposition:
		//    type=[PlatformComposableElement|QN]  rolename=ID ('[' lowerBound=INT ':' upperBound=(INT|SIGNED_INT) ']')? (description=STRING)? (':' specializes=[PlatformCharacteristic|QN])?  '->' realizes=[LogicalComposition|QN]
		//        // NOTE: This has a single, optional attribute - so the curlies are optional also
		//        ('{'
	...
	public class PlatformParticipantElements extends AbstractParserRuleElementFinder {
		...
		//PlatformParticipant:
		//    type=[PlatformEntity|QN]  rolename=ID ('[' lowerBound=INT ':' upperBound=(INT|SIGNED_INT) ']')? (description=STRING)? (':' specializes=[PlatformCharacteristic|QN])?  '->' realizes=[LogicalParticipant|QN] '{'
		//        'source:' '[' sourceLowerBound=INT ':' sourceUpperBound=(INT|SIGNED_INT) ']'
	...
	public class PlatformCompositeQueryElements extends AbstractParserRuleElementFinder {
		...
		//PlatformCompositeQuery:
		//    'pcquery' name=ID  (description=STRING)? ('->' realizes=[LogicalCompositeQuery|QN])? '{'
		//        isUnion?='isUnion'
	...
	private final ElementAttrsElements pElementAttrs;
	...
	private final LogicalAbstractMeasurementElements pLogicalAbstractMeasurement;
	...
	public UddlGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tSIGNED_INT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "com.epistimis.uddl.Uddl.SIGNED_INT");
		this.tLONG = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "com.epistimis.uddl.Uddl.LONG");
		this.tFLOAT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "com.epistimis.uddl.Uddl.FLOAT");
		this.tBOOLEAN = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "com.epistimis.uddl.Uddl.BOOLEAN");
		...
		this.pElementAttrs = new ElementAttrsElements();
		...
		this.pLogicalAbstractMeasurement = new LogicalAbstractMeasurementElements();
	...
	//// Handling LONGs also requires recognizing numerical representations that are too large to fit in an integer
	//terminal LONG returns ecore::ELong:  SIGNED_INT ("L"|"l");
	public TerminalRule getLONGRule() {
		return tLONG;
	}
	
	//terminal FLOAT returns ecore::EFloat : ('+'|'-')? DEC '.' DEC (('E'|'e') DEC)? ;
	public TerminalRule getFLOATRule() {
		return tFLOAT;
	}
	
	////DOUBLE returns ecore::EDouble : ('+'|'-')? DEC '.' DEC ('D'|'d');
	//terminal BOOLEAN returns ecore::EBoolean : ('true'|'false'|'TRUE'|'FALSE');
	...
	//    name=ID (description=STRING)?
	//;
	public ElementAttrsElements getElementAttrsAccess() {
		return pElementAttrs;
	}
	
	public ParserRule getElementAttrsRule() {
		return getElementAttrsAccess().getRule();
	}
	...
	//    LogicalValueTypeUnit  //Use LogicalElement
	//;
	public LogicalAbstractMeasurementElements getLogicalAbstractMeasurementAccess() {
		return pLogicalAbstractMeasurement;
	}
	
	public ParserRule getLogicalAbstractMeasurementRule() {
		return getLogicalAbstractMeasurementAccess().getRule();
	}
